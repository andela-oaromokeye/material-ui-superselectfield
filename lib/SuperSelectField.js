...
var SelectField = function (_Component2) {
  ...
  function SelectField(props, context) {
    ...
    _this3.closeMenu = function (reason, dontClose) {
      ...
      if (reason === 'offscreen') {
        _this3.setState({ isOpen: false }, _this3.root.focus);
      } else {
        _this3.setState({ isOpen: isOpen || false, searchText: '' }, function () {
      ...
      return function (event) {
        ...
        if (_this3.props.multiple) {
          ...
          _this3.setState({ selectedItems: updatedValue }, function () {
            return _this3.closeMenu(null, true);
          });
        }
      };
    };
    ...
    _this3.state = {
      isOpen: _this3.props.isOpen || false,
      isFocused: false,
